...
export default{
    ...
    methods: {
        ...
        {   
            ...
            if(this.cadastros.some( cadastro => cadastro.cpf_cnpj.toLowerCase().replace(/\D/g,'') === this.cpf_cnpj.toLowerCase().replace(/\D/g,'')))
            {
   ...
   <div class="card border-dark mb-3" style="max-width: 18rem;" >
        ...
        <div class="card-body text-dark" >
            ...
            <div>
                ...
                <h5>CPF/CNPJ</h5>
                <input v-model="cpf_cnpj" :disabled="edicaoInativa" v-mask="['###.###.###-##', '##.###.###/####-##']" placeholder="CPF ou CNPJ" />
                </div> 
        </div>
