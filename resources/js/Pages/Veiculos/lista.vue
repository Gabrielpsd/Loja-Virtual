...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <modalCadastraVeiculo v-if="cadastroVeiculoAtivo" :Clientes="this.Clientes" :Marcas="this.Marcas" :Cores="this.Cores" @fechaModal="cadastroVeiculoAtivo = false" @adicionar="(veiculo)=>this.veiculos.push(veiculo)"/>
         <div class="py-12" >
           <div class="bg-white overflow-hidden shadow-sm justify-between sm:rounded-lg flex ">
               ...
               <selectListMultiple id="proprietario" :label="'Proprietario'" v-model="proprietario" :options="this.Clientes"/>
               <selectListMultiple id="cores" :label="'Cores'" v-model="cor" :options="this.Cores"/>
               <selectListMultiple id="marcas" :label="'Marcas'" v-model="marca" :options="this.Marcas"/>
        ...
        <div>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mx-auto p-2">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                    <tr v-for="veiculo in filtraBusca">
